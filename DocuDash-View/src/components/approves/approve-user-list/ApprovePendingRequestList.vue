      ...
      <div class="w-full   mx-auto ">
        <div class="relative overflow-hidden bg-white  dark:bg-gray-800 ">
          <div
            ...
            <div>
              <h5 class="mr-3 font-semibold dark:text-white text-3xl">คำร้องที่รอการอนุมัติจากผู้จัดการ</h5>
              <p class="text-gray-500 ">รวมรายการเอกสารและโครงการที่รอการอนุมัติจากผู้จัดการ</p>
            </div>
          </div>
        </div>
      </div>
