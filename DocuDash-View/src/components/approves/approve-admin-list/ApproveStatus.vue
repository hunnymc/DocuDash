      ...
      <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
        <div
          ...
          <div
            ...
            <button class="flex items-center justify-center flex-shrink-0 px-3 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                    type="button">
            ...
            <tr v-for="item in approveList"
              ...
              <td class="w-4 px-4 py-3">
                <div class="flex items-center">
                  <input id="checkbox-table-search-1" class="w-4 h-4 bg
                  -gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" type="checkbox">
...
<!--                    </li>-->
              ...
              <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                <div class="flex items-center">
                  <svg class="w-5 h-5 mr-2 text-gray-400" fill="#000000" viewBox="0 0 100 100"
                    ...
                    <g id="SVGRepo_iconCarrier"> <g> <g> <path
                        d="M80,71.2V74c0,3.3-2.7,6-6,6H26c-3.3,0-6-2.7-6-6v-2.8c0-7.3,8.5-11.7,16.5-15.2c0.3-0.1,0.5-0.2,0.8-0.4 c0.6-0.3,1.3-0.3,1.9,0.1C42.4,57.8,46.1,59,50,59c3.9,0,7.6-1.2,10.8-3.2c0.6-0.4,1.3-0.4,1.9-0.1c0.3,0.1,0.5,0.2,0.8,0.4 C71.5,59.5,80,63.9,80,71.2z"></path> </g>
                      <g> <ellipse cx="50" cy="36.5" rx="14.9" ry="16.5"></ellipse> </g> </g> </g></svg>
                  {{ item.totalManagersWhoVerified }} / {{ item.totalManagers }}
                </div>
              </td>

              <!--  <td class="px-4 py-2">ด่วน</td>-->
              <td class="px-4 py-2">{{ item.documentInfo.urgency }}</td>

              <!--              <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">วันนี้</td>-->
              <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                {{
                  dateUpdateShowList[moment().diff(moment.unix(item.documentInfo.dateUpdate), 'days')] || 'เกิน 1 ปีที่แล้ว'
                }}
              </td>
            ...
            <!--              <td class="px-4 py-2">-->
            <!--                <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">คำร้องแจ้งให้ทราบ</span>-->
            <!--              </td>-->
            <!--              <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">-->
            <!--                <div class="flex items-center">-->
            ...
            <!--                </div>-->
            <!--              </td>-->
            <!--              <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">1/11/2011</td>-->
            <!--              <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">นายไข่,นายหอย,นายหี</td>-->
            <!--              <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">-->
            <!--                <div class="flex items-center">-->
            ...
            <!--                    <li class="flex w-full items-center text-blue-600 dark:text-blue-500 after:content-[''] after:w-full after:h-1 after:border-b after:border-blue-100 after:border-4 after:inline-block dark:after:border-blue-800">-->
            <!--        <span class="flex items-center justify-center w-2 h-2 bg-blue-100 rounded-full lg:h-6 lg:w-6 dark:bg-blue-800 shrink-0">-->
            <!--            <svg class="w-2 h-2 text-blue-600 lg:w-3 lg:h-3 dark:text-blue-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">-->
            <!--                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5"/>-->
            <!--            </svg>-->
            <!--        </span>-->
            <!--                    </li>-->
            <!--                    <li class="flex w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-100 after:border-4 after:inline-block dark:after:border-gray-700">-->
            <!--        <span class="flex items-center justify-center w-2 h-2 bg-gray-100 rounded-full lg:h-6 lg:w-6 dark:bg-gray-700 shrink-0">-->
            <!--            <svg class="w-2 h-2 text-gray-500 lg:w-3 lg:h-3 dark:text-gray-100" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 16">-->
            <!--                <path d="M18 0H2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2ZM6.5 3a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5ZM3.014 13.021l.157-.625A3.427 3.427 0 0 1 6.5 9.571a3.426 3.426 0 0 1 3.322 2.805l.159.622-6.967.023ZM16 12h-3a1 1 0 0 1 0-2h3a1 1 0 0 1 0 2Zm0-3h-3a1 1 0 1 1 0-2h3a1 1 0 1 1 0 2Zm0-3h-3a1 1 0 1 1 0-2h3a1 1 0 1 1 0 2Z"/>-->
            <!--            </svg>-->
            <!--        </span>-->
            <!--                    </li>-->
            <!--                    <li class="flex items-center w-full">-->
            <!--        <span class="flex items-center justify-center w-10 h-10 bg-gray-100 rounded-full lg:h-6 lg:w-6 dark:bg-gray-700 shrink-0">-->
            <!--            <svg class="w-4 h-4 text-gray-500 lg:w-3 lg:h-3 dark:text-gray-100" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">-->
            ...
            <!--              <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">-->
            <!--                <div class="flex items-center">-->
            <!--                  <div class="inline-block w-4 h-4 mr-2 bg-blue-500 rounded-full"></div>-->
            <!--                  รอผู้ดูแลตรวจสอบ-->
            <!--                </div>-->
            <!--              </td>-->
            <!--              <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">1/11/2011</td>-->
