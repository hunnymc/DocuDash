...
<template>
    ...
    <div data-popper-arrow></div>
              ...
              <div class="w-full">
                  ...
                  <div class="block p-1 w-24 bg-gray-50 border border-gray-300 text-sm text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg ">
        <h3 class="text-sm font-bold text-gray-900 dark:text-white ">12345X</h3>
        ...
        <h3 class="text-sm font-bold text-gray-900 dark:text-white ">เรื่องเสียวยามดึก</h3>
              ...
              <div class="w-full ">
                  ...
                  <div class="block w-5/6 p-2.5 bg-gray-50 border border-gray-300 text-sm text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg ">
        <h3 class="text-sm font-bold text-gray-900 dark:text-white ">หนุ่มน้อยร้อยเอ็ด</h3>
              ...
              <div class="w-full">
                  ...
                  <div class="block w-5/6 p-2.5 bg-gray-50 border border-gray-300 text-sm text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg ">
        <h3 class="text-sm font-bold text-gray-900 dark:text-white ">สยิวกิ้วกิ๊ว</h3>
              ...
              <div>
                  ...
                  <div class="block w-5/6 p-2.5 bg-gray-50 border border-gray-300 text-sm text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg ">
        <h3 class="text-sm font-bold text-gray-900 dark:text-white ">นักเสียว</h3>
              ...
              <div class="w-full">
                  ...
                  <div class="block w-5/6 p-2.5 bg-gray-50 border border-gray-300 text-sm text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg ">
        <h3 class="text-sm font-bold text-gray-900 dark:text-white ">0944444444</h3>
              ...
              <div class="w-full">
                  ...
                  <div class="block w-5/6 p-2.5 bg-gray-50 border border-gray-300 text-sm text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg ">
        <h3 class="text-sm font-bold text-gray-900 dark:text-white ">Siew@hmail.com</h3>
        ...
        <h3 class="text-sm font-bold text-gray-900 dark:text-white ">เรื่องเสียวยามดึก</h3>
              ...
              <div>
                  ...
                  <div class="block w-5/6 p-2.5 bg-gray-50 border border-gray-300 text-sm text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg ">
        <h3 class="text-sm font-bold text-gray-900 dark:text-white ">ด่วนที่สุด</h3>
              ...
              <div>
                  ...
                  <div class="block w-5/6 p-2.5 bg-gray-50 border border-gray-300 text-sm text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg ">
        <h3 class="text-sm font-bold text-gray-900 dark:text-white ">ลับสุดยอด</h3>
    ...
    <li class="w-full hover:bg-gray-50 border-b border-gray-200 rounded-t-lg dark:border-gray-600">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <div class="w-full">
                  <label for="description" class="block mb-2 text-sm font-bold text-gray-900 dark:text-white">หมายเหตุ</label>
                  <div class="block w-5/6 p-2.5 bg-gray-50 border border-gray-300 text-sm text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg ">
