            ...
            <div>
                <form>
                    <div class="m-4">
                        ...
                        <button @click="sendMessage()" class="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" type="button">Send</button>
                    </div>
                ...
                <form class="form-inline">
                    <div class="form-group">
                        ...
                        <input  v-model="privateMessage" type="text" id="private-message" class="m-4"
                            placeholder="Enter your message here...">
                        <button @click="sendPrivateMessage()" id="send-private" class="text-white bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900" type="button">Send
                            Private
                            Message</button>
                    </div>
                </form>
