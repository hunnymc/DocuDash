      ...
      <li>
             ...
             งาน Release หน้า
                <div class="tooltip-arrow" data-popper-arrow></div>
                            ...
                            <!-- <button class="absolute right-0 flex items-center p-1" tabindex="-1">
                                <svg class="w-5 h-5 stroke-current" fill="none" viewBox="0 0 24 24">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="1.5" d="M15.25 10.75L12 14.25L8.75 10.75"></path>
                                </svg>
                            </button> -->
                        </div>
                        <br>
        ...
        <div v-if="isAdmin">
            ...
            <div class="px-6 pt-4 pb-8">
                ...
                <button data-tooltip-target="testtool" data-tooltip-trigger="click" type="button" class="text-white bg-green-500 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-1 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    <svg class="-translate-x-3 rtl:rotate-180 w-7 h-7 ms-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <rect  fill="white"></rect> <path d="M12 6V18" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M6 12H18" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>เพิ่มผู้ใช้ใหม่
             ...
             งาน Release หน้า
                ...
                <ul>
                    <li class="relative text-white hover:text-white focus-within:text-white">
                        ...
                        <a href="#"
                            class="inline-block w-full py-2 pl-8 pr-4 text-xs rounded hover:bg-neutral-900 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:bg-gray-800">พัสดุและคลัง</a>
                    </li>
                    <li class="relative text-white hover:text-white focus-within:text-white">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-2 pointer-events-none">
                            <svg class="w-5 h-5 stroke-current" fill="none" viewBox="0 0 24 24">
                        ...
                        <a href="#"
                            class="inline-block w-full py-2 pl-8 pr-4 text-xs rounded hover:bg-neutral-900 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:bg-gray-800">จัดการระบบ</a>
                    </li>
                </ul>
            </div>
        </div>
