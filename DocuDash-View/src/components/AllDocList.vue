...
<template>
  <div class="w-full relative overflow-x-auto shadow-md ">
    ...
    <table class="w-full text-sm text-left rtl:text-right text-white">
      ...
      <tr class="bg-white text-gray-600 border-b border-gray-200 hover:bg-gray-50">
        <td class="w-4 p-4">
          {{ index + 1 }}
        </td>
        <th scope="row" class="px-6 py-4 font-medium">
          <a v-on:click="clickToViewDoc(thisdoc.documentsDocumentid1.id, thisdoc)"
             class="cursor-pointer hover:text-blue-700 text-gray-900  font-semibold text-base  hover:underline">{{
              thisdoc.documentsDocumentid1.title
            }}
          </a>
        </th>
        <td class="px-6 py-4">
          {{ thisdoc.documentsDocumentid1.description.length > 50 ? thisdoc.documentsDocumentid1.description.substring(0, 50) + '.......' : thisdoc.documentsDocumentid1.description }}
        </td>
              ...
              <a class="font-medium text-amber-400 hover:underline">
                <svg class="w-6 h-6" id="Icons" xmlns="http://www.w3.org/2000/svg"
                  ...
                  <g id="SVGRepo_iconCarrier">
                                            <path class="st0"
                                                  d="M5,21l-2,8l8-2L30,8l0,0c-0.6-3-3-5.4-6-6l0,0L5,21z"></path>
