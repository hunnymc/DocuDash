  ...
  const response = await axios
      ...
      .then(function (axiosResponse) {
        ...
        if (listdata.value.length > 0) {
          ...
          // filter category is "เอกสารภายใน"
          listdata.value = listdata.value.filter(
              (item) => item.documentsDocumentid1.category === "เอกสารภายใน"
          );
      ...
      <div class="w-full   mx-auto ">
        <div class="relative overflow-hidden bg-green-800 ">
          <div
            ...
            <div>
              <h5 class="mr-3 font-semibold text-white text-3xl">รายการเอกสารหมวดหมู่ภายใน</h5>
              <p class="text-gray-100 ">รวมรายการเอกสารหมวดหมู่ภายในที่เกี่ยวข้องกับท่าน</p>
            </div>
          </div>
        </div>
      </div>
